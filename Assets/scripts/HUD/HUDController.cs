...
public class HUDController : MonoBehaviour
{
    ...
    [Header("Main")] public Text speedDisplay;
    ...
    public Text roll;
    public Text timer;
    [Header("Debug")] public GameObject debugScreen;
    public float refreshTime = 0.5f;
    public Text leftSide;
    [Header("Curves")] public AnimationCurve nitroBarCurve;
    ...
    private void Update()
    {
        ...
        if (controller.jetAmount < 0.2f)
            nitroBar.color = Color32.Lerp(redColor, yellowColor, nitroBarCurve.Evaluate(controller.jetAmount * 5));
        else if (controller.jetAmount < 0.6f)
            nitroBar.color = Color32.Lerp(yellowColor, greenColor,
                nitroBarCurve.Evaluate((controller.jetAmount - 0.2f) * 2.5f));
