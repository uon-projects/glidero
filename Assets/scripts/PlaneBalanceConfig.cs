...
public class PlaneBalanceConfig : ScriptableObject
{
    ...
    [Header("Control")] [Tooltip("Basic multiplier for roll")]
    public float rollControlSensitivity = 0.2f;

    [Tooltip("Basic multiplier for roll")] public float pitchControlSensitivity = 0.2f;
    [Tooltip("Basic multiplier for roll")] public float yawControlSensitivity = 0.2f;
    ...
    [Tooltip("Curve that maps nitro increase to distance from ground")] [Header("Nitro")]
    ...
    [Tooltip("How much power thrust has")] public float thrust = 0;

    [Header("Other")] [Tooltip("Min velocity needed to brake")]
